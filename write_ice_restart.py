...
def create_tile_rst(fin, fout, tilesize, aice_in, vice_in, 
   ...
   with Dataset(fin) as src, Dataset(fout, "w") as dst:
    ...
    # copy all file data except for the excluded
      ...
      print 'all vars have been created' 
      ...
      print '1st batch vars have been processed' 
      ...
      print '2nd batch vars have been processed' 

      if 'TWMTS' in src.variables:
         dst['TWMTS'][:] = 0.0
      if 'HSKINW' in src.variables:
         dst['HSKINW'][:] =  2.0*MAPL_RHOWTR
      print '3rd batch vars have been processed' 
      ...
      dst['VOLSNO'][:] = vsno_in
      dst['TSKINI'][:] = tskin_in
      print '5th batch vars have been processed' 
      dst['ERGICE'][:] = eice_in
      dst['ERGSNO'][:] = esno_in
      print '6th batch vars have been processed' 
